...

    {
...

        {
...

            {
                ...
                this.style.border = "5px solid red"; //changes to red when a puzzle piece is near an empty space
                ...
                this.style.backgroundImage="url('../images/game/background.jpg')";
...

        {
            ...
            this.style.border = "5px solid blue"; //reverts to its original size border
